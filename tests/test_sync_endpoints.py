"""Comprehensive endpoint testing for Secreton API - Sync version."""
...
class SyncEndpointTester:
    """Test all API endpoints systematically with sync client."""
    ...
    def run_all_tests(self) -> None:
        ...
        print("🚀 Starting comprehensive endpoint testing (Sync)...")
        print(f"📡 API URL: {self.base_url}")
        print("=" * 80)

        with SyncSecretOnClient(self.base_url, self.token) as client:
            self.client = client
    ...
    def test_orders_endpoints(self) -> None:
...
def main():
    ...
    # Run tests
    tester = SyncEndpointTester(BASE_URL, TOKEN)
